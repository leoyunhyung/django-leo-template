...
LOCAL_APPS = [
    "leotemplate.apps.users.apps.UsersConfig",
]
...
MIGRATION_MODULES = {"sites": "leotemplate.contrib.sites.migrations"}
...
AUTH_PASSWORD_VALIDATORS = [
    ...
    # {'NAME': 'leotemplate.utils.validators.CustomPasswordValidator'},
]
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "leotemplate.utils.context_processors.settings_context",
            ],
        },
    }
]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "leotemplate.apps.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/forms.html
ACCOUNT_FORMS = {"signup": "leotemplate.apps.users.forms.UserSignupForm"}
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "leotemplate.apps.users.adapters.SocialAccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/forms.html
SOCIALACCOUNT_FORMS = {"signup": "leotemplate.apps.users.forms.UserSocialSignupForm"}
...
REST_FRAMEWORK = {
    ...
    "EXCEPTION_HANDLER": "leotemplate.utils.exception_handlers.custom_exception_handler",
...
SWAGGER_SETTINGS = {
    "DEFAULT_AUTO_SCHEMA_CLASS": "leotemplate.utils.api.schema.CustomAutoSchema",
